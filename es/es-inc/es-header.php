  ...
  <div class="main-wrapper">
    <div class="wrapper-without-footer">
      ...
      <div class="top-heading-container clearfix">
        <h1 class="top-heading-main-title"><a href="indice.php">Atlass Institute Of Technology</a></h1>
        <div class="top-heading-number">Llamenos al (703) 352-7777</div>
      </div>
        ...
        <div class="outer-ul-and-language-switcher-container-wrapper">
          ...
          <div class="language-switcher-container">        
            <div class="flags-container">
              <a href=<?php echo $currentPageEnglishEquivalent ?>><img class="flag" src="../img/american-flag.png" alt="Picture of American Flag" /></a>
              <a href=<?php echo $currentPage ?>><img class="flag mexican-flag"src="../img/mexican-flag.png" alt="Picture of Mexican Flag" /></a>
            </div>
